...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(t)
      : ((e = "undefined" != typeof globalThis ? globalThis : e || self).Tabulator = t())
})(this, function () {
  "use strict"
  var e = {
  ...
  class i {
      ...
      return (
        ...
        new Proxy(this, {
          get: function (e, t, i) {
            return void 0 !== e[t]
              ? e[t]
              : e._column.table.componentFunctionBinder.handle("column", e._column, t)
          }
        })
      )
    }
    ...
    setWidth(e) {
      var t
      return (
        (t = !0 === e ? this._column.reinitializeWidth(!0) : this._column.setWidth(e)),
  ...
  class n extends t {
    ...
    _configureCell() {
      ...
      this.column.vertAlign &&
        ...
        (e.style.alignItems =
          { top: "flex-start", bottom: "flex-end", middle: "center" }[this.column.vertAlign] || ""),
        this.column.hozAlign &&
          (e.style.justifyContent =
            { left: "flex-start", right: "flex-end", center: "center" }[this.column.hozAlign] ||
            "")),
    ...
    setValueProcessData(e, t, i) {
      ...
      return (
        (this.value !== e || i) &&
          ((s = !0), t && (e = this.chain("cell-value-changing", [this, e], null, e))),
  ...
  class r extends t {
    ...
    attachColumn(e) {
      this.groupElement
        ? (this.columns.push(e), this.groupElement.appendChild(e.getElement()), e.columnRendered())
        : console.warn(
    ...
    verticalAlign(e, t) {
      ...
      ;((this.element.style.height = i + "px"),
        ...
        this.isGroup &&
          (this.groupElement.style.minHeight = i - this.contentElement.offsetHeight + "px"),
    ...
    getLastColumn() {
      return this.isGroup
        ? !!this.columns.length && this.columns[this.columns.length - 1].getLastColumn()
        : this
    }
    getColumns(e) {
      var t = []
    ...
    checkColumnVisibility() {
      ...
      ;(this.columns.forEach(function (t) {
        ...
        e
          ? (this.show(), this.dispatchExternal("columnVisibilityChanged", this.getComponent(), !1))
          : this.hide())
    }
    show(e, t) {
      this.visible ||
  ...
  class l {
    ...
    generate(e, t = {}) {
      ...
      for (let e in t)
        i.hasOwnProperty(e) ||
          (s && console.warn("Invalid " + this.msgType + " option:", e), (i[e] = t.key))
      for (let e in i)
        e in t
          ? (i[e] = t[e])
          : Array.isArray(i[e])
  ...
  class h extends t {
    ...
    styleRow(e, t) {
      var i = e.getElement()
      t % 2
        ? (i.classList.add("tabulator-row-even"), i.classList.remove("tabulator-row-odd"))
        : (i.classList.add("tabulator-row-odd"), i.classList.remove("tabulator-row-even"))
    }
    clear() {
      ...
      return new Promise((r, l) => {
        if (s > -1) {
          if (
            ...
            !i &&
              a.elVisible(o) &&
              (n = a.elOffset(o).top - a.elOffset(this.elementVertical).top) > 0 &&
  ...
  class c extends h {
    ...
    scrollColumns(e, t) {
      this.scrollLeft != e &&
        ((this.scrollLeft = e), this.scroll(e - (this.vDomScrollPosLeft + this.windowBuffer)))
    }
    calcWindowBuffer() {
        ...
        this.table.columnManager.columnsByIndex.forEach(e => {
          ...
          e.visible &&
            (e.modules.frozen ||
              ...
              (i.width = t),
              this.isFitData &&
                (i.fitDataCheck = !e.modules.vdomHoz || e.modules.vdomHoz.fitDataCheck),
              s + t > this.vDomScrollPosLeft && s < this.vDomScrollPosRight
                ? (-1 == this.leftCol &&
                    ((this.leftCol = this.columns.length), (this.vDomPadLeft = s)),
    ...
    getVisibleRows() {
      return (
        this.visibleRows || (this.visibleRows = this.table.rowManager.getVisibleRows()),
        this.visibleRows
      )
    }
    scroll(e) {
            ...
            this.getVisibleRows().forEach(e => {
              if ("group" !== e.type) {
                ...
                ;(e
                  ...
                  .insertBefore(
                    t.getElement(),
                    e.getCell(this.columns[this.rightCol]).getElement().nextSibling
                  ),
                  t.cellRendered())
              }
            }),
  ...
  class u extends t {
          ...
          (s.forEach(e => {
            Object.keys(e).forEach((s, o) => {
              ...
              i[s]
                ? !0 !== i[s] &&
                  void 0 !== r &&
                  ((i[s].sorter = this.calculateSorterFromValue(r)), (i[s] = !0))
                : ((n = { field: s, title: s, sorter: this.calculateSorterFromValue(r) }),
                  t.splice(o, 0, n),
                  (i[s] = void 0 !== r || n))
            })
          }),
      ...
      ;((this.columns = []),
        ...
        this.table.options.rowHeader &&
          ((this.rowHeader = new r(
            !0 === this.table.options.rowHeader ? {} : this.table.options.rowHeader,
            this,
            !0
          )),
    ...
    _addColumn(e, t, i) {
      ...
      if (
        ...
        t
          ...
          : (this.columns.splice(l + 1, 0, s), h.parentNode.insertBefore(o, h.nextSibling))
      } else
        t
          ? (this.columns.unshift(s),
            this.headersElement.insertBefore(s.getElement(), this.headersElement.firstChild))
          : (this.columns.push(s), this.headersElement.appendChild(s.getElement()))
    ...
    getFlexBaseWidth() {
      var e = this.table.element.clientWidth,
        t = 0
      return (
        this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight &&
          (e -=
      ...
      return new Promise((o, n) => {
        ...
        ;(i
          ? (this.normalizeHeight(!0),
            this.table.options.rowFormatter && this.table.options.rowFormatter(this.getComponent()))
          : ((this.initialized = !1), (this.height = 0), (this.heightStyled = "")),
  ...
  class g extends h {
    ...
    scrollToRowNearestTop(e) {
      ...
      return !(
        ...
        Math.abs(this.elementVertical.scrollTop + this.elementVertical.clientHeight - t)
      )
    }
    scrollToRow(e) {
      var t = e.getElement()
      this.elementVertical.scrollTop =
        a.elOffset(t).top - a.elOffset(this.elementVertical).top + this.elementVertical.scrollTop
    }
    visibleRows(e) {
      return this.rows()
    }
  ...
  class b extends h {
    ...
    scrollRows(e, t) {
      ...
      if (((this.scrollTop = e), -i > o || s > o)) {
        ...
        ;(this._virtualRenderFill(
          Math.floor(
            (this.elementVertical.scrollTop / this.elementVertical.scrollHeight) * n.length
          )
        ),
    ...
    _virtualRenderFill(e, t, i) {
      ...
      if (g && a.elVisible(this.elementVertical)) {
        for (
          this.vDomTop = e,
            ...
            C || this.table.options.maxHeight
              ...
              : (w = g);
          (w == g || h <= E + this.vDomWindowBuffer || v < this.vDomWindowMinTotalRows) &&
          this.vDomBottom < g - 1;
        ) {
          for (
        ...
        ;(e
          ? ((this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - u),
            (this.vDomBottomPad =
              this.vDomBottom == g - 1
                ? 0
      ...
      for (var i = [], s = 0, o = 0, n = !0; n; ) {
        ...
        a && o < this.vDomMaxRenderChain
          ? ((r = a.getHeight() || this.vDomRowHeight),
            t >= r ? (this.vDomTop++, (t -= r), (s += r), i.push(a), o++) : (n = !1))
          : (n = !1)
      }
      for (let e of i) {
        let t = e.getElement()
    ...
    _removeBottomRow(e, t) {
      for (var i = [], s = 0, o = 0, n = !0; n; ) {
        ...
        a && o < this.vDomMaxRenderChain
          ? ((r = a.getHeight() || this.vDomRowHeight),
            t >= r ? (this.vDomBottom--, (t -= r), (s += r), i.push(a), o++) : (n = !1))
          : (n = !1)
      }
      for (let e of i) {
        let t = e.getElement()
  ...
  class f extends t {
      ...
      if (
        ...
        if ((t.classList.add("tabulator-placeholder"), "string" == typeof e)) {
          ...
          "undefined" != typeof HTMLElement && e instanceof HTMLElement
            ...
            : (console.warn("Invalid placeholder provided, must be string or HTML Element", e),
              (this.el = null))
        this.placeholder = t
      }
    }
    ...
    addRowActual(e, t, i, s) {
      ...
      return (
        i ||
          ((n = this.chain("row-adding-position", [r, a], null, { index: i, top: a })),
          (i = n.index),
          (a = n.top)),
    ...
    nextDisplayRow(e, t) {
      var i = this.getDisplayRowIndex(e),
        s = !1
      return (
        !1 !== i && i < this.displayRowsCount - 1 && (s = this.getDisplayRows()[i + 1]),
            ...
            (!this.redrawBlockRestoreConfig ||
              (this.redrawBlockRestoreConfig &&
                ((this.redrawBlockRestoreConfig.stage === o &&
                  ...
                  r.indexOf(o) < r.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
            (this.redrawBlockRestoreConfig = {
              handler: e,
              skipStage: t,
              renderInPosition: i,
        ...
        ;(a.elVisible(this.element)
          ? i
            ...
            : (this.refreshPipelines(e, o, n, i),
              ...
              this.renderTable(),
              s.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0))
          : this.refreshPipelines(e, o, n, i),
    ...
    resetScroll() {
      if (
        ((this.element.scrollLeft = 0), (this.element.scrollTop = 0), "ie" === this.table.browser)
      ) {
  ...
  class w extends t {
    ...
    pseudoMouseLeave(e, t) {
      ...
      ;(i = i.filter(t => {
        ...
        this.pseudoTrackers[e].target &&
          (this.dispatch(e + "-mouseleave", t, i), (this.pseudoTrackers[e].target = null))
      })
    }
    ...
    updateEventListeners() {
      for (let e in this.listeners) {
        ...
        t.components.length
          ? t.handler ||
            ((t.handler = this.track.bind(this, e)), this.el.addEventListener(e, t.handler))
  ...
  class x extends t {
    ...
    checkMsg(e, t) {
      return (
        void 0 === this.options(e) ||
        (this._warnUser(
          "%cDeprecated Setup Option - Use of the %c" + e + " %c option is now deprecated, " + t,
          "font-weight: normal;",
          "font-weight: bold;",
          "font-weight: normal;"
        ),
    ...
    elementPositionCoords(e, t = "right") {
      ...
      switch (
        (this.container !== document.body &&
          ((i = a.elOffset(this.container)), (n.left -= i.left), (n.top -= i.top)),
        t)
      ) {
        case "right":
  ...
  class M extends t {
    ...
    displayRows(e) {
      ...
      if (
        (this._handler &&
          (t = this.table.rowManager.displayPipeline.findIndex(e => e.handler === this._handler)) >
            -1 &&
          (i = t),
        e && (i += e),
        this._handler)
    ...
    fitDataStretch: function (e, t) {
      ...
      ;(e.forEach((e, t) => {
        ;(e.widthFixed || e.reinitializeWidth(),
          (this.table.options.responsiveLayout ? e.modules.responsive.visible : e.visible) &&
            (n = e),
              ...
              : e.column.maxWidth && e.column.maxWidth < r
                ? ((e.width = e.column.maxWidth),
                  ...
                  (h -= s
                    ...
                    : e.column.definition.widthGrow || 1) && (i = Math.floor(t / h)))
                : (p.push(e),
                  (c += s
                    ? e.column.definition.widthShrink || 1
            ...
            t
              ? ((s = u(t)),
                ...
                e.definition.widthShrink &&
                  (h.push({ column: e, width: s > i ? s : i }), (d += e.definition.widthShrink)))
  ...
  class D extends M {
    ...
    initialize() {
      ...
      ;(D.modes[e]
        ? (this.mode = e)
        : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e),
          (this.mode = "fitData")),
    ...
    layout(e) {
      var t = this.table.columnManager.columnsByIndex.find(
        e => e.definition.variableHeight || "textarea" === e.definition.formatter
      )
      ...
      if (
        ...
        this.langList[t]
          ? (console.warn(
            ...
            (e = t))
          : (console.warn("Localization Error - Matching locale not found, using default: ", e),
            (e = "default"))
      }
      ;((this.locale = e),
        ...
        "default" != e &&
          (function e(t, i) {
            for (var s in t)
              "object" == typeof t[s] ? (i[s] || (i[s] = {}), e(t[s], i[s])) : (i[s] = t[s])
    ...
    CommsModule: class extends M {
      ...
      send(e, t, i, s) {
        ...
        ;(o.forEach(e => {
          ...
          !o.length &&
            e &&
            console.warn("Table Connection Error - No tables matching selector found", e))
      }
      receive(e, t, i, s) {
      ...
      lookupTable(e, t) {
        ...
        if ("string" == typeof e) {
          if ((i = document.querySelectorAll(e)).length)
            for (var n = 0; n < i.length; n++) (s = H.registry.matchElement(i[n])) && o.push(s)
        } else
  ...
  class _ extends H {
    ...
    static initializeModuleBinder(e) {
      _.modulesRegistered ||
        ((_.modulesRegistered = !0), _._registerModules(F, !0), e && _._registerModules(e))
    }
    ...
    static _registerModuleBinding(e) {
      e.moduleName
        ...
        : console.error("Unable to bind module, no moduleName defined", e.moduleName)
    }
  ...
  class A extends _ {
      ...
      return "undefined" != typeof HTMLElement && e instanceof HTMLElement
        ...
        : "string" == typeof e
          ? ((this.element = document.querySelector(e)),
            !!this.element ||
              (console.error("Tabulator Creation Error - no element found matching selector: ", e),
              !1))
    ...
    _buildElement() {
      ...
      for (t.classList.add("tabulator"), t.setAttribute("role", "grid"); t.firstChild; )
        t.removeChild(t.firstChild)
      ;(i.height &&
        ((i.height = isNaN(i.height) ? i.height : i.height + "px"), (t.style.height = i.height)),
        !1 !== i.minHeight &&
    ...
    initGuard(e, t) {
      ...
      return (
        this.options.debugInitialization &&
          ...
          (e ||
            (e =
              " " == (s = "Error" == (i = new Error().stack.split("\n"))[0] ? i[2] : i[1])[0]
    ...
    deleteRow(e) {
      ...
      return (
        t.sort((e, t) =>
          this.rowManager.rows.indexOf(e) > this.rowManager.rows.indexOf(t) ? 1 : -1
        ),
        t.forEach(e => {
          e.delete()
        }),
    ...
    deleteColumn(e) {
      ...
      return (
        ...
        t
          ? t.delete()
          : (console.warn("Column Delete Error - No matching column found:", e), Promise.reject())
      )
    }
    updateColumnDefinition(e, t) {
      ...
      return (
        ...
        i
          ...
          : (console.warn("Column Update Error - No matching column found:", e), Promise.reject())
      )
    }
    moveColumn(e, t, i) {
    ...
    initializeColumn(e) {
      ...
      ;(this.allowedTypes.forEach(s => {
        ...
        e.definition[n] &&
          ...
          ((t = !0), (i[n] = { accessor: o, params: e.definition[n + "Params"] || {} }))
      }),
    ...
    lookupAccessor(e) {
      ...
      switch (typeof e) {
        case "string":
          V.accessors[e]
            ? (t = V.accessors[e])
            : console.warn("Accessor Error - No such accessor found, ignoring: ", e)
          break
        case "function":
          t = e
      }
    ...
    return new Promise((o, n) => {
      ...
      e
        ? (void 0 === t.headers && (t.headers = {}),
          ...
          "cors" == t.mode
            ? (void 0 === t.headers.Origin && (t.headers.Origin = window.location.origin),
  ...
  class X extends M {
    ...
    requestData(e, t, i, s, o) {
      ...
      return !o && this.requestDataCheck(e)
        ? (e && this.setUrl(e), (n = this.generateConfig(i)), this.sendRequest(this.url, t, n))
        : o
    }
    setDefaultConfig(e = {}) {
        ...
        actions: {
          copyToClipboard: function (e) {
            this.table.modules.edit.currentCell ||
              (this.table.modExists("clipboard", !0) && this.table.modules.clipboard.copy(!1, !0))
          }
        }
      }
    }
  class $ extends M {
        ...
        (!0 !== this.mode && "copy" !== this.mode) ||
          ...
          void 0 !== window.getSelection && void 0 !== document.createRange
            ...
            : void 0 !== document.selection &&
              ...
              ((s = document.body.createTextRange()).moveToElementText(this.table.element),
              s.select()),
    ...
    checkPasteOrigin(e) {
      var t = !0
      return (
        (!this.confirm("clipboard-paste", [e]) && ["DIV", "SPAN"].includes(e.target.tagName)) ||
          (t = !1),
        t
      )
    }
  ...
  class ee extends M {
    ...
    restoreRedraw() {
      ;((this.blocked = !1),
        this.recalcAfterBlock && ((this.recalcAfterBlock = !1), this.recalcActiveRowsRefresh()))
    }
    userRecalc() {
      ...
      ;(e.column.definition.topCalc || e.column.definition.bottomCalc) &&
        (this.table.options.groupBy
          ? (("table" != this.table.options.columnCalcs &&
              ...
              this.recalcActiveRows(),
            "table" != this.table.options.columnCalcs && this.recalcRowGroup(e.row))
          : this.recalcActiveRows())
    }
        ...
        switch (typeof t.topCalc) {
          case "string":
            ee.calculations[t.topCalc]
              ...
              : console.warn("Column Calc Error - No such calculation found, ignoring: ", t.topCalc)
            break
          case "function":
            i.topCalc = t.topCalc
        }
    ...
    removeCalcs() {
      ...
      ;(this.topInitialized &&
        ...
        (e = !0)),
        this.botInitialized &&
          ((this.botInitialized = !1), this.footerRemove(this.botElement), (e = !0)),
              ...
              e
                ? (o.push(
                  ...
                  (e.width > 1 || e.height > -1) &&
                    ...
                    i.push({ s: { r: s, c: t }, e: { r: s + e.height - 1, c: t + e.width - 1 } }))
                : o.push("")
            }),
              t.push(o))
          }),
  ...
  let oe = class {
    ...
    _onRendered() {
      ...
      ;(this.isFilter ||
        ((this.input.style.height = "100%"), this.input.focus({ preventScroll: !0 })),
    ...
    _createInputElement() {
      ...
      if (
        ...
        for (let i in e)
          "+" == i.charAt(0)
            ? ((i = i.slice(1)), t.setAttribute(i, t.getAttribute(i) + e["+" + i]))
    ...
    _initializeParams(e) {
      ...
      return (
        ...
        (e.placeholderLoading =
          void 0 === e.placeholderLoading ? "Searching ..." : e.placeholderLoading),
        (e.placeholderEmpty =
          void 0 === e.placeholderEmpty ? "No Results Found" : e.placeholderEmpty),
    ...
    _keyDown(e) {
      var t = this.displayItems.indexOf(this.focusedItem)
      ;("editor" == this.params.verticalNavigation ||
        ("hybrid" == this.params.verticalNavigation && t < this.displayItems.length - 1)) &&
        (e.stopImmediatePropagation(),
        e.stopPropagation(),
        e.preventDefault(),
    ...
    _keySelectLetter(e) {
      this.params.autocomplete ||
        (e.preventDefault(), e.keyCode >= 38 && e.keyCode <= 90 && this._scrollToValue(e.keyCode))
    }
    ...
    _scrollToValue(e) {
      ...
      var i = this.displayItems.find(
        e => void 0 !== e.label && e.label.toLowerCase().startsWith(this.filterTerm)
      )
      ;(i && this._focusItem(i),
        (this.filterTimeout = setTimeout(() => {
          this.filterTerm = ""
    ...
    _focusItem(e) {
      ;((this.lastAction = "focus"),
        ...
        e &&
          ...
          e.element.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "start" })))
    }
      ...
      return (
        ...
        t instanceof Promise
          ? (e || this._addPlaceholder(this.params.placeholderLoading),
            t.then().then(e => (this.listIteration === i ? this._parseList(e) : Promise.reject(i))))
    ...
    _addPlaceholder(e) {
      ...
      ;("function" == typeof e && (e = e(this.cell.getComponent(), this.listEl)),
        e &&
          ...
          e instanceof HTMLElement
            ? (t = e)
            : (t.classList.add("tabulator-edit-list-placeholder"), (t.innerHTML = e)),
    ...
    _ajaxRequest(e, t) {
      return (
        ...
        fetch(e)
          .then(e =>
            e.ok
              ? e
                  ...
                  .catch(
                    e => (
                      console.warn("List Ajax Load Error - Invalid JSON returned", e),
                      Promise.reject(e)
                    )
                  )
              : (console.error(
          ...
          .catch(
            e => (console.error("List Ajax Load Error - Connection Error: ", e), Promise.reject(e))
          )
      )
    }
    ...
    _defaultSortFunction(e, t) {
      ...
      if (("desc" === this.params.sort && ([e, t] = [t, e]), e || 0 === e)) {
        if (t || 0 === t) {
          ...
          for (
            i = i.match(l), s = s.match(l), r = i.length > s.length ? s.length : i.length;
            a < r;
          )
            if ((o = i[a]) !== (n = s[a++]))
    ...
    _defaultFilterFunc(e, t, i, s) {
      return (
        ...
        null != t &&
          (String(t).toLowerCase().indexOf(e) > -1 || String(i).toLowerCase().indexOf(e) > -1)
      )
    }
    _clearList() {
        ...
        if (!i) {
          if (
            ...
            for (let t in e.elementAttributes)
              "+" == t.charAt(0)
                ? ((t = t.slice(1)),
                  i.setAttribute(t, this.input.getAttribute(t) + e.elementAttributes["+" + t]))
    ...
    _styleItem(e) {
      e &&
        e.element &&
        (e.selected ? e.element.classList.add("active") : e.element.classList.remove("active"))
    }
    _itemClick(e, t) {
    ...
    _resolveValue(e) {
      ...
      ;("" === t && (t = this.params.emptyValue),
        ...
        this.isFilter &&
          ((this.initialValues = t && !Array.isArray(t) ? [t] : t), (this.currentItems = [])))
    }
  }
  var ne = {
        ...
        l.addEventListener("keydown", function (e) {
          switch (e.keyCode) {
            ...
            case 38:
              ...
              break
            case 40:
              ;("editor" == r || ("hybrid" == r && l.selectionStart !== l.value.length)) &&
                (e.stopImmediatePropagation(), e.stopPropagation())
              break
            case 35:
            case 36:
    ...
    date: function (e, t, i, s, o) {
      ...
      function d(e) {
        return (
          a.isDateTime(e) ? e : "iso" === n ? a.fromISO(String(e)) : a.fromFormat(String(e), n)
        ).toFormat("yyyy-MM-dd")
      }
      if (
        ((h.type = "date"),
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              h.setAttribute(e, h.getAttribute(e) + o.elementAttributes["+" + e]))
    ...
    time: function (e, t, i, s, o) {
      ...
      if (
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              d.setAttribute(e, d.getAttribute(e) + o.elementAttributes["+" + e]))
        ...
        d.forEach(function (t, i) {
          i < e
            ? ("ie" == n.table.browser
                ...
                : t.classList.replace("tabulator-star-inactive", "tabulator-star-active"),
              (t.innerHTML =
    ...
    adaptable: function (e, t, i, s, o) {
      ...
      return (
        ...
        o.paramsLookup &&
          (r = "function" == typeof o.paramsLookup ? o.paramsLookup(n, e) : o.paramsLookup[n]),
  ...
  class re extends M {
    ...
    navigateLeft(e = this.currentCell, t) {
      ...
      return (
        !!(
          e &&
          (t && t.preventDefault(), (i = e.getIndex()), (s = this.findPrevEditableCell(e.row, i)))
    ...
    navigateRight(e = this.currentCell, t) {
      ...
      return (
        !!(
          e &&
          (t && t.preventDefault(), (i = e.getIndex()), (s = this.findNextEditableCell(e.row, i)))
        ) && (s.getComponent().edit(), !0)
      )
    }
    ...
    cancelEdit() {
      if (this.currentCell) {
        ...
        ;(this.clearEditor(!0),
          ...
          e.cellRendered(),
          ("textarea" == e.column.definition.editor || e.column.definition.variableHeight) &&
    ...
    focusCellNoEvent(e, t) {
      ;((this.recursionBlock = !0),
        (t && "ie" === this.table.browser) || e.getElement().focus({ preventScroll: !0 }),
        (this.recursionBlock = !1))
    }
    editCell(e, t) {
      ...
      if ("virtual" == this.table.rowManager.getRenderMode()) {
        ...
        s.offsetTop < t
          ...
          : s.offsetTop + s.offsetHeight > i &&
            (this.table.rowManager.element.scrollTop += s.offsetTop + s.offsetHeight - i)
        ...
        ;(this.table.modExists("frozenColumns") &&
          ...
          r.offsetLeft < o
            ...
            : r.offsetLeft + r.offsetWidth > n &&
              (this.table.rowManager.element.scrollLeft += r.offsetLeft + r.offsetWidth - n))
      }
    }
    allowEdit(e) {
    ...
    transformEmptyValues(e, t) {
      ...
      return (
        (s.convertEmptyValues || this.convertEmptyValues) &&
          (i = s.editorEmptyValueFunc || this.options("editorEmptyValueFunc")) &&
          i(e) &&
          (e = s.convertEmptyValues ? s.editorEmptyValue : this.options("editorEmptyValue")),
        e
      )
    }
    blur(e) {
          ...
          switch (e.type) {
            ...
            case "row":
              ;((n = this.generateRowElement(e, r, o)),
                this.mapElementStyles(t % 2 && o.evenRow ? o.evenRow : o.oddRow, n, [
                  "border-top",
                  "border-left",
                  "border-right",
                  "border-bottom",
          ...
          if (e) {
            ...
            ;((t.colSpan = e.width),
              ...
              e.component._column.parent && e.component._column.parent.isGroup
                ? this.mapElementStyles(e.component._column.parent.groupElement, t, ["border-top"])
                : this.mapElementStyles(e.component.getElement(), t, ["border-top"]),
              e.component._column.isGroup
                ? this.mapElementStyles(e.component.getElement(), t, ["border-bottom"])
                : this.mapElementStyles(this.table.columnManager.getElement(), t, [
                    "border-bottom"
                  ]),
              s.appendChild(t))
          }
      ...
      if (
        ...
        e.columns.forEach((o, n) => {
          if (o) {
            ...
            if (
              ((h.definition.cssClass ? h.definition.cssClass.split(" ") : []).forEach(
                function (e) {
                  l.classList.add(e)
                }
              ),
            ...
            ;(u instanceof Node ? l.appendChild(u) : (l.innerHTML = u),
              ...
              h.isRowHeader
                ...
                : (r = i.styleCells && i.styleCells[c] ? i.styleCells[c] : i.firstCell),
              r &&
  ...
  class me extends M {
    ...
    initializeColumn(e, t) {
      ...
      ;((e.modules.filter = {
        success: function (t) {
          var o,
            n =
              ("input" == e.modules.filter.tagType && "text" == e.modules.filter.attrType) ||
          ...
          if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
              ...
              if (!o)
                if ("partial" === n)
                  ((o = function (i) {
                    ...
                    return (
                      null != s && String(s).toLowerCase().indexOf(String(t).toLowerCase()) > -1
                    )
                  }),
                    (r = "like"))
                else
            ...
            ;((e.modules.filter.value = t),
              ...
              i.prevHeaderFilterChangeCheck !== a &&
                ((i.prevHeaderFilterChangeCheck = a), i.trackChanges(), i.refreshFilter()))
          }
          return !0
        },
        attrType: !1,
        ...
        if (o) {
          ...
          ;(c.langBind("headerFilters|columns|" + e.definition.field, function (t) {
            n.setAttribute(
              ...
              void 0 !== t && t
                ? t
                : e.definition.headerFilterPlaceholder || c.langText("headerFilters|default")
            )
          }),
            ...
            !1 !== e.definition.headerFilterLiveFilter &&
              ("autocomplete" !== e.definition.headerFilter &&
                "tickCross" !== e.definition.headerFilter &&
                (("autocomplete" !== e.definition.editor && "tickCross" !== e.definition.editor) ||
    ...
    setHeaderFilterFocus(e) {
      e.modules.filter && e.modules.filter.headerElement
        ...
        : console.warn("Column Filter Focus Error - No header filter set on column:", e.getField())
    }
          ...
          ;(t =
            "object" == typeof e.field
              ...
              : this.filterList.findIndex(
                  t => e.field === t.field && e.type === t.type && e.value === t.value
                )) > -1
  ...
  var pe = {
    ...
    money: function (e, t, i) {
      ...
      return (
        (a = o + n),
        !0 === h ? ((a = "(" + a + ")"), p ? a + m : m + a) : p ? h + a + m : h + m + a
      )
    },
    link: function (e, t, i) {
      var s,
    ...
    tickCross: function (e, t, i) {
      ...
      return (a && s === t.trueValue) ||
        (!a && ((r && s) || !0 === s || "true" === s || "True" === s || 1 === s || "1" === s))
    ...
    progress: function (e, t = {}, i) {
      ...
      if (
        ((g.style.position = "relative"), (g.style.width = "100%"), (g.style.height = "100%"), a)
      ) {
    ...
    rownum: function (e, t, i) {
      ...
      return (
        o.watchPosition(e => {
          ;(t.relativeToPage &&
            (e += n.modules.page.getPageSize() * (n.modules.page.getPage() - 1)),
            (s.innerText = e))
        }),
        s
      )
    ...
    adaptable: function (e, t, i) {
      ...
      return (
        ...
        t.paramsLookup &&
          (o = "function" == typeof t.paramsLookup ? t.paramsLookup(s, e) : t.paramsLookup[s]),
        ...
        t.valueMap &&
          (s =
            "string" == typeof t.valueMap
              ? function (e) {
                  return e.map(e =>
                    a.retrieveNestedData(r.options.nestedFieldSeparator, t.valueMap, e)
                  )
                }
              : t.valueMap),
  ...
  class ge extends M {
    ...
    initializeColumn(e) {
      ;((e.modules.format = this.lookupTypeFormatter(e, "")),
        ...
        void 0 !== e.definition.formatterClipboard &&
          (e.modules.format.clipboard = this.lookupTypeFormatter(e, "Clipboard")),
        void 0 !== e.definition.formatterHtmlOutput &&
          (e.modules.format.htmlOutput = this.lookupTypeFormatter(e, "HtmlOutput")))
    }
    ...
    formatExportValue(e, t) {
      ...
      if (s) {
        ...
        return (
          (i = "function" == typeof s.params ? s.params(e.getComponent()) : s.params),
      ...
      return (
        ...
        new Proxy(this, {
          get: function (e, t, i) {
            return void 0 !== e[t]
              ? e[t]
              : e._group.groupManager.table.componentFunctionBinder.handle("group", e._group, t)
          }
        })
      )
    }
          ...
          ? (i.parentNode && i.parentNode.removeChild(i),
            this.groupManager.blockRedraw ||
              ...
              this.groupManager.table.modExists("columnCalcs") &&
                "table" != this.groupManager.table.options.columnCalcs &&
                this.groupManager.table.modules.columnCalcs.recalcGroup(this)))
          : (this.parent ? this.parent.removeGroup(this) : this.groupManager.removeGroup(this),
            this.groupManager.updateGroupRows(!0)))
    }
    removeGroup(e) {
      var t,
  ...
  class Ee extends M {
    ...
    rowDeleted(e) {
      var t, i
      ;(this.table.options.groupBy
        ? (t = (i = e.getComponent().getGroup()._getSelf().rows).indexOf(e)) && (t = i[t - 1])
        : (t = e.table.rowManager.getRowIndex(e)) && (t = e.table.rowManager.rows[t - 1]),
    ...
    clearComponentHistory(e) {
      ...
      t > -1 &&
        (this.history.splice(t, 1), t <= this.index && this.index--, this.clearComponentHistory(e))
    }
    undo() {
      if (this.index > -1) {
  ...
  class Re extends M {
    ...
    loadDataCheck(e) {
      return (
        this.table.options.importFormat &&
        ("string" == typeof e || (Array.isArray(e) && e.length && Array.isArray(e)))
      )
    }
    loadData(e, t, i, s, o) {
      return this.importData(this.lookupImporter(), e)
        ...
        .catch(
          e => (console.error("Import Error:", e || "Unable to import data"), Promise.reject(e))
        )
    }
    lookupImporter(e) {
      var t
    ...
    validateData(e) {
      ...
      return this.table.options.importDataValidator
        ? !0 === (t = this.table.options.importDataValidator.call(this.table, e))
          ? e
          : Promise.reject(t)
        : e
    }
  ...
  var xe = {
    ...
    Te = {
      ...
      scrollPageUp: function (e) {
        ...
        ;(e.preventDefault(),
          t.displayRowsCount &&
            (i >= 0 ? (t.element.scrollTop = i) : t.scrollToRow(t.getDisplayRows()[0])),
  ...
  class Se extends M {
    ...
    initializeGroupHeader(e) {
      ...
      ;((i.mouseup = function (i) {
        ...
        (i.mousemove = function (i) {
          var s
          i.pageY - a.elOffset(e.element).top + t.table.rowManager.element.scrollTop >
          e.getHeight() / 2
            ? (t.toRow === e && t.toRowAfter) ||
              ((s = e.getElement()).parentNode.insertBefore(t.placeholderElement, s.nextSibling),
              t.moveRow(e, !0))
            : (t.toRow !== e || t.toRowAfter) &&
              (s = e.getElement()).previousSibling &&
              (s.parentNode.insertBefore(t.placeholderElement, s), t.moveRow(e, !1))
        }.bind(t)),
        (e.modules.moveRow = i))
    }
    initializeRow(e) {
      ...
      ;((s.mouseup = function (t) {
        ...
        (s.mousemove = function (t) {
          var s = e.getElement()
          t.pageY - a.elOffset(s).top + i.table.rowManager.element.scrollTop > e.getHeight() / 2
            ? (i.toRow === e && i.toRowAfter) ||
              (s.parentNode.insertBefore(i.placeholderElement, s.nextSibling), i.moveRow(e, !0))
            : (i.toRow !== e || i.toRowAfter) &&
              (s.parentNode.insertBefore(i.placeholderElement, s), i.moveRow(e, !1))
        }.bind(i)),
        this.hasHandle ||
          ...
          this.moving &&
            ...
            (h = t.touches[0].pageY - l) > 0
              ? i &&
                ...
                d
                  .getElement()
                  .parentNode.insertBefore(this.placeholderElement, d.getElement().nextSibling),
                this.moveRow(d, !0))
              : s &&
                -h - a > n &&
                (d = s) !== e &&
    ...
    _bindMouseMove() {
      this.table.rowManager.getDisplayRows().forEach(e => {
        ;("row" === e.type || "group" === e.type) &&
          ...
          e.getElement().addEventListener("mousemove", e.modules.moveRow.mousemove)
      })
    }
    _unbindMouseMove() {
      this.table.rowManager.getDisplayRows().forEach(e => {
        ;("row" === e.type || "group" === e.type) &&
          e.modules.moveRow &&
          e.modules.moveRow.mousemove &&
          e.getElement().removeEventListener("mousemove", e.modules.moveRow.mousemove)
      })
    }
    startMove(e, t) {
      var i = t.getElement()
    ...
    connectToTables(e) {
      ...
      ;(this.connectionSelectorsTables &&
        ...
        this.commsSend(this.connectionSelectorsTables, "moveRow", "connect", { row: e })),
    ...
    initializeColumn(e) {
      ...
      ;(this.allowedTypes.forEach(s => {
        ...
        e.definition[n] &&
          ...
          ((t = !0), (i[n] = { mutator: o, params: e.definition[n + "Params"] || {} }))
      }),
    ...
    lookupMutator(e) {
      ...
      switch (typeof e) {
        case "string":
          ze.mutators[e]
            ? (t = ze.mutators[e])
            : console.warn("Mutator Error - No such mutator found, ignoring: ", e)
          break
        case "function":
          t = e
      }
  ...
  class Fe extends M {
    ...
    rowAddingPosition(e, t) {
      ...
      return (
        t
          ? o.length
            ? (i = o[0])
            : s.activeRows.length && ((i = s.activeRows[s.activeRows.length - 1]), (t = !1))
    ...
    remotePageParams(e, t, i, s) {
      return (
        this.initialLoad ||
          (((this.progressiveLoad && !i) || (!this.progressiveLoad && !this.dataChanging)) &&
            this.reset(!0)),
        (s.page = this.page),
    ...
    userSetPageToRow(e) {
      return this.table.options.pagination && (e = this.table.rowManager.findRow(e))
        ? this.setPageToRow(e)
        : Promise.reject()
    }
    userSetPageSize(e) {
    ...
    scrollVertical(e, t) {
      ...
      t ||
        ...
        ((i = this.table.rowManager.getElement()).scrollHeight - i.clientHeight - e <
          (this.table.options.progressiveLoadScrollMargin || 2 * i.clientHeight) &&
          this.nextPage().catch(() => {}))
    }
    ...
    _e = {
      ...
      cookie: function (e, t, i) {
        ...
        ;(s.setDate(s.getDate() + 1e4),
          (document.cookie =
            e + "-" + t + "=" + JSON.stringify(i) + "; expires=" + s.toUTCString()))
      }
    }
  class Oe extends M {
      ...
      if (this.table.options.persistence) {
        ...
        ;((this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie"),
          ...
          (this.config = {
            ...
            headerFilter:
              !0 === this.table.options.persistence || this.table.options.persistence.headerFilter,
          ...
          this.config.page &&
            ...
            void 0 === e.paginationInitialPage ||
              ...
              (this.table.options.paginationInitialPage = e.paginationInitialPage)),
          this.config.group &&
  ...
  class Ve {
      ...
      return (
        ...
        new Proxy(this, {
          get: function (e, t, i) {
            return void 0 !== e[t]
              ? e[t]
              : e._range.table.componentFunctionBinder.handle("range", e._range, t)
          }
        })
      )
    }
    ...
    setStartBound(e) {
      this._range.destroyedGuard("setStartBound") &&
        (this._range.setEndBound(e ? e._cell : e), this._range.rangeManager.layoutElement())
    }
    setEndBound(e) {
  ...
  class Ie extends t {
    constructor(e, t, i, s) {
      ;(super(e),
        ...
        this.rangeManager.rowHeader &&
          ((this.left = 1), (this.right = 1), (this.start.col = 1), (this.end.col = 1)),
        this.initElement(),
        setTimeout(() => {
          this.initBounds(i, s)
        }))
    ...
    setEnd(e, t) {
      ;(this.end.row === e && this.end.col === t) ||
        ((this.end.row = e), (this.end.col = t), (this.initializing.end = !0), this._updateMinMax())
    }
    setBounds(e, t, i) {
    ...
    setStartBound(e) {
      var t, i
      "column" === e.type
        ? this.rangeManager.columnSelection && this.setStart(0, e.getPosition() - 1)
        : ((t = e.row.position - 1),
      ...
      "column" === e.type
        ? this.rangeManager.columnSelection &&
          ("column" === this.rangeManager.selecting
            ...
            : "cell" === this.rangeManager.selecting && this.setEnd(0, e.getPosition() - 1))
        : ((t = e.row.position - 1),
          (i = e.column.getPosition() - 1),
      ...
      ;((this.top = Math.min(this.start.row, this.end.row)),
        ...
        this.initialized
          ...
          : this.initializing.start &&
            ...
            ((this.initialized = !0), this.dispatchExternal("rangeAdded", this.getComponent())))
    }
    _getTableColumns() {
    ...
    layout() {
      ...
      ;("virtual" === this.table.options.renderHorizontal &&
        ...
        this.overlaps(u, d, m, c) &&
          ...
          this.table.rtl
            ? ((this.element.style.right = l.offsetWidth - r.offsetLeft - r.offsetWidth + "px"),
              (this.element.style.width = r.offsetLeft + r.offsetWidth - a.offsetLeft + "px"))
    ...
    destroyedGuard(e) {
      return (
        this.destroyed &&
          console.warn("You cannot call the " + e + " function on a destroyed range"),
        !this.destroyed
      )
    }
  }
          ...
          return (
            !!(
              ...
              i &&
                ...
                r.length &&
                  (n = (o = this.table.columnManager.getVisibleColumnsByIndex()).indexOf(
                    i.column
                  )) > -1))
            ) &&
  ...
  function We(e, t, i, s, o, n, r) {
    ...
    if (void 0 !== a) {
      if (
        (a.isDateTime(e) || (e = "iso" === l ? a.fromISO(String(e)) : a.fromFormat(String(e), l)),
        ...
        (r.valueMap &&
          (l =
            "string" == typeof r.valueMap
              ? function (e) {
                  return e.map(e =>
                    a.retrieveNestedData(u.options.nestedFieldSeparator, r.valueMap, e)
                  )
                }
              : r.valueMap),
        Array.isArray(e))
    ...
    alphanum: function (e, t, i, s, o, n, r) {
      ...
      if (e || 0 === e) {
        if (t || 0 === t) {
          ...
          for (
            a = a.match(m), l = l.match(m), c = a.length > l.length ? l.length : a.length;
            u < c;
          )
            if ((h = a[u]) !== (d = l[u++]))
  ...
  class Ge extends M {
    ...
    initializeColumn(e) {
      ...
      switch (typeof e.definition.sorter) {
        case "string":
          Ge.sorters[e.definition.sorter]
            ...
            : console.warn("Sort Error - No such sorter found: ", e.definition.sorter)
          break
        case "function":
      ...
      if (
        ...
        ;(e.titleHolderElement.appendChild(i),
          ...
          ("icon" === this.table.options.headerSortClickElement ? i : t).addEventListener(
            "click",
            t => {
              var i = "",
                s = [],
              ...
              if (e.modules.sort) {
                ...
                ;(this.table.options.columnHeaderSortMulti && (t.shiftKey || t.ctrlKey)
                  ? ((o = (s = this.getSort()).findIndex(t => t.field === e.getField())),
                    o > -1
                      ? ((s[o].dir = i), (o = s.splice(o, 1)[0]), "none" != i && s.push(o))
    ...
    getSort() {
      ...
      return (
        this.sortList.forEach(function (t) {
          t.column &&
            e.push({ column: t.column.getComponent(), field: t.column.getField(), dir: t.dir })
        }),
        e
      )
    }
    ...
    findSorter(e) {
      ...
      if (i && ((i = i.getData()), e.getField()))
        switch (typeof (t = e.getFieldValue(i))) {
          ...
          default:
            isNaN(t) || "" === t
              ? t.match(/((^[0-9]+[a-z]+)|(^[a-z]+[0-9]+))+$/i) && (s = "alphanum")
              : (s = "number")
        }
      return Ge.sorters[s]
    }
    ...
    setColumnHeaderSortIcon(e, t) {
      ...
      if (e.definition.headerSort && "function" == typeof this.table.options.headerSortElement) {
        ...
        "object" ==
        typeof (i = this.table.options.headerSortElement.call(this.table, e.getComponent(), t))
          ? s.appendChild(i)
          : (s.innerHTML = i)
      }
    }
  ...
  class Ue {
    ...
    incrementChar(e) {
      ...
      t
        ? "Z" !== t
          ? (this.columnString[e] = String.fromCharCode(this.columnString[e].charCodeAt(0) + 1))
      ...
      return (
        ...
        new Proxy(this, {
          get: function (e, t, i) {
            return void 0 !== e[t]
              ? e[t]
              : e._sheet.table.componentFunctionBinder.handle("sheet", e._sheet, t)
          }
        })
      )
    }
  ...
  var qe = {
    integer: function (e, t, i) {
      return (
        "" === t || null == t || ((t = Number(t)), !isNaN(t) && isFinite(t) && Math.floor(t) === t)
      )
    },
    ...
    in: function (e, t, i) {
      return (
        "" === t || null == t || ("string" == typeof i && (i = i.split("|")), i.indexOf(t) > -1)
      )
    },
  ...
  var Ye = Object.freeze({
    ...
    DataTreeModule: class extends M {
          ...
          switch (
            ...
            t.dataTreeBranchElement
              ? !0 === t.dataTreeBranchElement
                ...
                : "string" == typeof t.dataTreeBranchElement
                  ? (((e = document.createElement("div")).innerHTML = t.dataTreeBranchElement),
            ...
            t.dataTreeCollapseElement
              ? "string" == typeof t.dataTreeCollapseElement
                ? (((e = document.createElement("div")).innerHTML = t.dataTreeCollapseElement),
            ...
            t.dataTreeExpandElement
              ? "string" == typeof t.dataTreeExpandElement
                ? (((e = document.createElement("div")).innerHTML = t.dataTreeExpandElement),
      ...
      initializeRow(e) {
        ...
        ;(!s &&
          ...
          e.modules.dataTree.branchEl.parentNode.removeChild(e.modules.dataTree.branchEl),
          !s &&
            e.modules.dataTree &&
            e.modules.dataTree.controlEl &&
            e.modules.dataTree.controlEl.parentNode.removeChild(e.modules.dataTree.controlEl),
          (e.modules.dataTree = {
            index: e.modules.dataTree ? e.modules.dataTree.index : 0,
            open:
              !!s &&
              (e.modules.dataTree ? e.modules.dataTree.open : this.startOpen(e.getComponent(), 0)),
      ...
      layoutRow(e) {
        ...
        ;(i.branchEl &&
          ...
          (i.branchEl = !1)),
          i.controlEl &&
            (i.controlEl.parentNode && i.controlEl.parentNode.removeChild(i.controlEl),
            (i.controlEl = !1)),
              ...
              ? ((i.branchEl = this.branchEl.cloneNode(!0)),
                ...
                this.table.rtl
                  ? (i.branchEl.style.marginRight =
                      (i.branchEl.offsetWidth + i.branchEl.style.marginLeft) * (i.index - 1) +
                      i.index * this.indent +
                      "px")
                  : (i.branchEl.style.marginLeft =
                      (i.branchEl.offsetWidth + i.branchEl.style.marginRight) * (i.index - 1) +
                      i.index * this.indent +
                      "px"))
              : this.table.rtl
                ? (t.style.paddingRight =
                    parseInt(window.getComputedStyle(t, null).getPropertyValue("padding-right")) +
                    i.index * this.indent +
                    "px")
                : (t.style.paddingLeft =
                    parseInt(window.getComputedStyle(t, null).getPropertyValue("padding-left")) +
                    i.index * this.indent +
                    "px")))
      }
      ...
      rowDelete(e) {
        ...
        ;(i &&
          (!1 !== (t = this.findChildIndex(e, i)) && i.data[this.field].splice(t, 1),
      ...
      findChildIndex(e, t) {
        ...
        return (
          "object" == typeof e
            ...
            : (i =
                void 0 !== e &&
                t.data[this.field].find(t => t.data[this.table.options.index] == e)),
          i &&
            (Array.isArray(t.data[this.field]) && (i = t.data[this.field].indexOf(i)),
            -1 == i && (i = !1)),
          i
        )
      }
    ...
    FrozenColumnsModule: class extends M {
      ...
      layout() {
        this.active &&
          !this.blocked &&
          (this.layoutColumnPosition(), this.reinitializeRows(), this.layoutCalcRows())
      }
      reinitializeRows() {
      ...
      adjustForScrollbar(e) {
        this.rightColumns.length &&
          (this.table.columnManager.getContentsElement().style.width = "calc(100% - " + e + "px)")
      }
      getFrozenColumns() {
    ...
    InteractionModule: class extends M {
      ...
      cellContentsSelectionFixer(e, t) {
        ...
        if (!this.table.modExists("edit") || this.table.modules.edit.currentCell !== t) {
          ...
          try {
            document.selection
              ? ((i = document.body.createTextRange()).moveToElementText(t.getElement()),
                i.select())
              : window.getSelection &&
        ...
        t
          ...
          : this.eventMap[e].includes("-")
            ? !this.subscribers[e] ||
              ...
              (this.unsubscribe(this.eventMap[e], this.subscribers[e]), delete this.subscribers[e])
      ...
      dispatchEvent(e, t, i) {
        var s,
          o = i.getComponent()
        ;(this.columnSubscribers[e] &&
          (i instanceof n ? (s = i.column.definition[e]) : i instanceof r && (s = i.definition[e]),
          s && s(t, o)),
            ...
            e.parent === i.moving.parent &&
              ...
              e.getWidth() / 2
                ? (i.toCol === e && i.toColAfter) ||
                  ...
                  i.moveColumn(e, !0))
                : (i.toCol !== e || i.toColAfter) &&
                  (t.parentNode.insertBefore(i.placeholderElement, t), i.moveColumn(e, !1)))
          }.bind(i)),
      ...
      _bindMouseMove() {
        this.table.columnManager.columnsByIndex.forEach(function (e) {
          e.modules.moveColumn.mousemove &&
            e.getElement().addEventListener("mousemove", e.modules.moveColumn.mousemove)
        })
      }
      _unbindMouseMove() {
        this.table.columnManager.columnsByIndex.forEach(function (e) {
          e.modules.moveColumn.mousemove &&
            e.getElement().removeEventListener("mousemove", e.modules.moveColumn.mousemove)
        })
      }
      moveColumn(e, t) {
            ...
            value: function () {
              ...
              return (
                i.blocked ||
                  ...
                  (i.block("data-pop"),
                  i.data.length &&
                    (s = i.table.rowManager.getRowFromDataObject(i.data[i.data.length - 1])) &&
                    s.deleteActual(),
    ...
    ResizeColumnsModule: class extends M {
      ...
      layoutCellHandles(e) {
        "row" === e.row.type &&
          (this.deInitializeComponent(e), this.initializeColumn("cell", e, e.column, e.element))
      }
      ...
      reinitializeColumn(e) {
        ...
        ;(e.cells.forEach(i => {
          ...
          e.modules.resize &&
            ...
            (t && (e.modules.resize.handleEl.style[e.modules.frozen.position] = t),
    ...
    ResizeRowsModule: class extends M {
      ...
      resize(e, t) {
        t.setHeight(
          this.startHeight +
            ((void 0 === e.screenY ? e.touches[0].screenY : e.screenY) - this.startY)
        )
      }
      calcGuidePosition(e, t, i) {
              ...
              ? (this.initializeVisibilityObserver(),
                ...
                (this.resizeObserver = new ResizeObserver(e => {
                  if (
                    !t.browserMobile ||
                    (t.browserMobile &&
                      (!t.modules.edit || (t.modules.edit && !t.modules.edit.currentCell)))
                  ) {
    ...
    ResponsiveLayoutModule: class extends M {
      ...
      initializeRow(e) {
        var t
        "calc" !== e.type &&
          ((t = document.createElement("div")).classList.add("tabulator-responsive-collapse"),
      ...
      layoutRow(e) {
        ...
        e.modules.responsiveLayout &&
          (t.appendChild(e.modules.responsiveLayout.element), this.generateCollapsedRowContent(e))
      }
      updateColumnVisibility(e, t) {
        !t &&
          e.modules.responsive &&
          ((e.modules.responsive.visible = e.visible), this.initializeResponsivity())
      }
      hideColumn(e) {
      ...
      showColumn(e) {
        ...
        ;(e.show(!1, !0),
          ...
          "collapse" === this.mode &&
            ((t = this.hiddenColumns.indexOf(e)) > -1 && this.hiddenColumns.splice(t, 1),
            this.generateCollapsedContent(),
            this.collapseHandleColumn &&
              !this.hiddenColumns.length &&
              this.collapseHandleColumn.hide()))
          ...
          e.forEach(e => {
            ...
            ;(o.appendChild(r),
              ...
              e.value instanceof Node
                ? ((i = document.createElement("div")).appendChild(e.value), n.appendChild(i))
                : (n.innerHTML = e.value),
              s.appendChild(o),
              s.appendChild(n),
              t.appendChild(s))
    ...
    SelectRangeModule: class extends M {
      ...
      updateHeaderColumn() {
        ...
        ;(this.rowSelection &&
          ...
          this.table.modules.frozenColumns &&
            ...
            ((e = this.table.modules.frozenColumns.getFrozenColumns()).length > 1 ||
      ...
      initializeFocus(e) {
        ...
        try {
          document.selection
            ? ((t = document.body.createTextRange()).moveToElementText(e.getElement()), t.select())
            : window.getSelection &&
        ...
        if (
          (this.ranges.length > 1 &&
            (this.ranges = this.ranges.filter(e =>
              e === this.activeRange ? (e.setEnd(e.start.row, e.start.col), !0) : (e.destroy(), !1)
            )),
          (n = { top: (s = this.activeRange).top, bottom: s.bottom, left: s.left, right: s.right }),
        ...
        return (
          ...
          n.top !== s.top || n.bottom !== s.bottom || n.left !== s.left || n.right !== s.right
            ? ((l = this.getRowByRangePos(s.end.row)),
              ...
              (u.left >= m.left + this.getRowHeaderWidth() && u.right <= m.right) ||
                (l.getElement().parentNode && h.getElement().parentNode
                  ? this.autoScroll(s, l.getElement(), h.getElement())
      ...
      autoScroll(e, t, i) {
        ...
        ;(void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()),
          ...
          (n =
            ...
            o.top < s.bottom &&
            s.bottom < o.bottom),
          (o.left < s.left && s.left < o.right && o.left < s.right && s.right < o.right) ||
            (s.left < o.left
          ...
          n ||
            (s.top < o.top
              ? (r.scrollTop = s.top)
              : s.bottom > o.bottom && (r.scrollTop = s.bottom - r.clientHeight)))
      }
      layoutChange() {
      ...
      layoutElement(e) {
        ;((e ? this.table.rowManager.getVisibleRows(!0) : this.table.rowManager.getRows()).forEach(
          e => {
      ...
      layoutRanges() {
        ...
        this.table.initialized &&
          ...
          this.table.rtl
            ...
            : (this.activeRangeCellElement.style.left = i.offsetLeft + t.offsetLeft + "px"),
      ...
      resetRanges() {
        ...
        return (
          ...
          this.table.rowManager.activeRows.length &&
            ((i = this.table.rowManager.activeRows[0].cells.filter(e => e.column.visible)),
    ...
    SelectRowModule: class extends M {
      ...
      checkRowSelectability(e) {
        return (
          !(!e || "row" !== e.type) &&
          this.table.options.selectableRowsCheck.call(this.table, e.getComponent())
        )
      }
      toggleRow(e) {
    ...
    SpreadsheetModule: class extends M {
      ...
      tableInitialized() {
        this.sheets.length
          ...
          : this.options("spreadsheetSheets")
            ...
            : this.options("spreadsheetData") && this.loadData(this.options("spreadsheetData"))
      }
      loadRemoteData(e, t, i) {
        return (
          ...
          Array.isArray(e)
            ? (this.table.dataLoader.clearAlert(),
              this.dispatchExternal("dataLoaded", e),
              !e.length || Array.isArray(e[0]) ? this.loadData(e) : this.loadSheets(e))
            : console.error(
      ...
      loadSheet(e) {
        this.activeSheet !== e &&
          (this.activeSheet && this.activeSheet.unload(), (this.activeSheet = e), e.load())
      }
      newSheet(e = {}) {
        var t
        return (
