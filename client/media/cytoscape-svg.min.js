 ...
 * Original file: /npm/cytoscape-svg@0.4.0/cytoscape-svg.js
 *
  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      var i =
        ...
        s = {}
      ;((s.number = function (t) {
        return null != t && (void 0 === t ? "undefined" : i(t)) === i(1) && !isNaN(t)
      }),
        (o.bufferCanvasImage = function (t, e) {
          ...
          ;((e.renderer().usePaths = function () {
            ...
            e.elements().forEach(function (t) {
              ;((t._private.rscratch.pathCacheKey = null), (t._private.rscratch.pathCache = null))
            }))
          var i = e.renderer(),
            ...
            p = i.getPixelRatio(),
            u = 1
          if (void 0 !== t.scale) ((l *= t.scale), (h *= t.scale), (u = t.scale))
          else if (c) {
            var _ = 1 / 0,
              d = 1 / 0
            ;(s.number(t.maxWidth) && (_ = (u * t.maxWidth) / l),
              s.number(t.maxHeight) && (d = (u * t.maxHeight) / h),
              (l *= u = Math.min(_, d)),
              (h *= u))
          }
          c || ((l *= p), (h *= p), (u *= p))
    ...
    function (t, e, r) {
      !(function () {
        ...
        function a(t) {
          ...
          do {
            for (r = "", i = 0; i < 12; i++) r += e[Math.floor(Math.random() * e.length)]
          } while (t[r])
          return r
        }
        function l(t) {
        ...
        ;((o = (function (t, e) {
          ...
          for (t = t.split(","), e = e || 10, r = 0; r < t.length; r += 2)
            ((i = "&" + t[r + 1] + ";"), (n = parseInt(t[r], e)), (o[i] = "&#" + n + ";"))
          return ((o["\\xa0"] = "&#160;"), o)
        })(
          ...
          ((i = function (t, e) {
            ...
            ;(i.setAttribute("offset", t),
              -1 !== e.indexOf("rgba")
                ? ((r = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi.exec(e)),
                  i.setAttribute(
                    "stop-color",
          ...
          ((r = function (t) {
            ...
            ;((this.width = e.width || i.width),
              ...
              (this.enableMirroring =
                void 0 !== e.enableMirroring ? e.enableMirroring : i.enableMirroring),
              (this.canvas = this),
            ...
            var i,
              ...
              s = Object.keys(e)
            for (
              r && (o.setAttribute("fill", "none"), o.setAttribute("stroke", "none")), i = 0;
              i < s.length;
              i++
            )
            ...
            for (o = 0; o < p.length; o++)
              if (((a = e[p[o]]), (l = this[p[o]]), a.apply))
                if (l instanceof n) {
                  ...
                  r.setAttribute(a.apply, s("url(#{id})", { id: l.__root.getAttribute("id") }))
                } else if (l instanceof i)
                  r.setAttribute(a.apply, s("url(#{id})", { id: l.__root.getAttribute("id") }))
                else if (-1 !== a.apply.indexOf(t) && a.svg !== l)
                  if (
                    ("stroke" !== a.svgAttr && "fill" !== a.svgAttr) ||
                    -1 === l.indexOf("rgba")
                  ) {
                    var u = a.svgAttr
                    if ("globalAlpha" === p[o] && ((u = t + "-" + a.svgAttr), r.getAttribute(u)))
                      continue
                    r.setAttribute(u, l)
                  } else {
                    ;((c = /rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?\.?\d*)\s*\)/gi.exec(
                      l
                    )),
                      r.setAttribute(
                        a.svgAttr,
                        s("rgb({r},{g},{b})", { r: c[1], g: c[2], b: c[3] })
                      ))
                    var _ = c[4],
                      d = this.globalAlpha
                    ;(null != d && (_ *= d), r.setAttribute(a.svgAttr + "-opacity", _))
                  }
          }),
          (r.prototype.__closestGroupOrSvg = function (t) {
            return "g" === (t = t || this.__currentElement).nodeName || "svg" === t.nodeName
              ? t
          ...
          (r.prototype.getSerializedSvg = function (t) {
            ...
            if (
              ...
              for (e = Object.keys(o), r = 0; r < e.length; r++)
                ((i = e[r]), (n = o[i]), (s = new RegExp(i, "gi")).test(a) && (a = a.replace(s, n)))
            return a
          }),
          ...
          (r.prototype.scale = function (t, e) {
            ;(void 0 === e && (e = t), this.__addTransform(s("scale({x},{y})", { x: t, y: e })))
          }),
          (r.prototype.rotate = function (t) {
            var e = (180 * t) / Math.PI
            this.__addTransform(s("rotate({angle},{cx},{cy})", { angle: e, cx: 0, cy: 0 }))
          }),
          ...
          (r.prototype.transform = function (t, e, r, i, n, o) {
            this.__addTransform(
              s("matrix({a},{b},{c},{d},{e},{f})", { a: t, b: e, c: r, d: i, e: n, f: o })
            )
          }),
          ...
          (r.prototype.quadraticCurveTo = function (t, e, r, i) {
            ;((this.__currentPosition = { x: r, y: i }),
              this.__addPathCommand(s("Q {cpx} {cpy} {x} {y}", { cpx: t, cpy: e, x: r, y: i })))
          }))
        var h = function (t) {
        ...
        ;((r.prototype.arcTo = function (t, e, r, i, n) {
          ...
          if (void 0 !== o && void 0 !== s) {
            if (n < 0)
              throw new Error("IndexSizeError: The radius provided (" + n + ") is negative.")
            if ((o === t && s === e) || (t === r && e === i) || 0 === n) this.lineTo(t, e)
            else {
              var a = h([o - t, s - e]),
                l = h([r - t, i - e])
              if (a[0] * l[1] != a[1] * l[0]) {
                var c = a[0] * l[0] + a[1] * l[1],
                  p = Math.acos(Math.abs(c)),
                  u = h([a[0] + l[0], a[1] + l[1]]),
                  _ = n / Math.sin(p / 2),
                  d = t + _ * u[0],
                  f = e + _ * u[1],
                  ...
                  v = y(g),
                  b = y(m)
                ;(this.lineTo(d + g[0] * n, f + g[1] * n), this.arc(d, f, n, v, b))
          ...
          (r.prototype.fillRect = function (t, e, r, i) {
            var n
            ;((n = this.__createElement("rect", { x: t, y: e, width: r, height: i }, !0)),
          ...
          (r.prototype.__clearCanvas = function () {
            ...
            ;((this.__currentElement = e), (this.__groupStack = []), t && this.__addTransform(t))
          }),
          ...
          (r.prototype.__wrapTextLink = function (t, e) {
            if (t.href) {
              ...
              return (
                r.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", t.href),
                r.appendChild(e),
                r
              )
            }
          ...
          (r.prototype.arc = function (t, e, r, i, n, o) {
            if (i !== n) {
              ...
              var a = t + r * Math.cos(n),
                ...
                _ = n - i
              ;(_ < 0 && (_ += 2 * Math.PI),
                (u = o ? (_ > Math.PI ? 0 : 1) : _ > Math.PI ? 1 : 0),
                this.lineTo(h, c),
                this.__addPathCommand(
                  s("A {rx} {ry} {xAxisRotation} {largeArcFlag} {sweepFlag} {endX} {endY}", {
                    rx: r,
                    ry: r,
                    xAxisRotation: 0,
                    largeArcFlag: u,
          ...
          (r.prototype.drawImage = function () {
            var t,
              ...
              g = 0,
              m = 0
            if (3 === d.length) ((t = d[1]), (e = d[2]), (i = o = f.width), (n = s = f.height))
            else if (5 === d.length)
              ((t = d[1]), (e = d[2]), (i = d[3]), (n = d[4]), (o = f.width), (s = f.height))
            else {
              if (9 !== d.length)
                throw new Error(
            ...
            var y = "translate(" + t + ", " + e + ")"
            if (f instanceof r) {
              if ((l = f.getSvg().cloneNode(!0)).childNodes && l.childNodes.length > 1) {
                ...
                if ((c = l.childNodes[1])) {
                  ...
                  ;((v = b ? b + " " + y : y), c.setAttribute("transform", v), a.appendChild(c))
                }
              }
            } else
              ("CANVAS" !== f.nodeName && "IMG" !== f.nodeName) ||
                ((p = this.__createElement("image")).setAttribute("width", i),
                p.setAttribute("height", n),
                p.setAttribute("opacity", this.globalAlpha),
                p.setAttribute("preserveAspectRatio", "none"),
                ((u = this.__document.createElement("canvas")).width = i),
                (u.height = n),
                u.getContext("2d").drawImage(f, g, m, o, s, 0, 0, i, n),
                (f = u),
                p.setAttribute("transform", y),
                p.setAttributeNS(
                  "http://www.w3.org/1999/xlink",
                  "xlink:href",
                  "CANVAS" === f.nodeName ? f.toDataURL() : f.getAttribute("src")
                ),
                a.appendChild(p))
          }),
          (r.prototype.createPattern = function (t, e) {
            var i,
              o = this.__document.createElementNS("http://www.w3.org/2000/svg", "pattern"),
              s = a(this.__ids)
            return (
              o.setAttribute("id", s),
              ...
              "CANVAS" === t.nodeName || "IMG" === t.nodeName
                ...
                : t instanceof r &&
                  (o.appendChild(t.__root.childNodes[1]), this.__defs.appendChild(o)),
              new n(o, this)
            )
          }),
