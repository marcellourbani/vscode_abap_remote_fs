import { type Either, isRight, left, right } from "fp-ts/lib/Either"
import { type Lazy, pipe } from "fp-ts/lib/function"
import { fromNullable, isNone, isSome, none, type None, type Option } from "fp-ts/lib/Option"
import {
  bind,
  chain,
  chainEitherK,
