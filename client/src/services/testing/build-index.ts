 ...
 * writes, not projects.
 *
 * Exposed to the AI as the `abapfs_build_test_index` language model tool — see
...
Auto-generated by the abapfs_build_test_index tool — do not hand-edit the tables below (the "## Notes" section at the bottom IS preserved and safe to edit).
