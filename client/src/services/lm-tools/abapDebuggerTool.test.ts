vi.mock("vscode", () => ({
  ...
  Position: vi.fn().mockImplementation(function (line: number, character: number) {
    return { line, character }
  }),
  Location: vi.fn().mockImplementation(function (uri: any, range: any) {
    return { uri, range }
  }),
  SourceBreakpoint: vi.fn().mockImplementation(function (
    location: any,
    enabled?: boolean,
    condition?: string
  ) {
