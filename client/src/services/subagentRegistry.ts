...
export const AGENT_REGISTRY: AgentMeta[] = [
    ...
    },
    {
        ...
        tier: 2,
        defaultModel: '',
        tools: ['debug-session', 'debug-breakpoint', 'debug-step', 'debug-variable', 'debug-stack', 'debug-status', 'abap-workspace-uri', 'abap-lines'],
    ...
    },
    {
        ...
        tier: 1,
        defaultModel: '',
        tools: ['mermaid-create', 'mermaid-validate', 'mermaid-docs', 'abap-lines', 'abap-search-lines', 'abap-where-used', 'abap-info'],
    ...
    },
    {
        ...
        tier: 1,
        defaultModel: '',
        tools: ['abap-lines', 'abap-batch', 'abap-search-lines', 'abap-info', 'abap-where-used', 'test-docs'],
 ...
 */
export async function getAvailableModels(): Promise<Array<{ id: string; name: string; vendor: string; family: string }>> {
    try {
 ...
 */
export async function validateModelConfiguration(): Promise<Array<{ agentId: string; configuredModel: string; available: boolean }>> {
