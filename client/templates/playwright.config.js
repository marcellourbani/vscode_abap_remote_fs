...
module.exports = defineConfig({
  ...
  globalTimeout: Number(process.env.SAP_TESTING_GLOBAL_TIMEOUT_MS ?? 3_600_000),
  maxFailures: Number(process.env.SAP_TESTING_MAX_FAILURES ?? 3),
  // Multiple files may run concurrently; tests inside one file retain authored order.
  fullyParallel: false,
